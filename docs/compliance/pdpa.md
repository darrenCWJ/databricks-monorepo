...
| Access (DSAR) | `projects/pdpa-dsar/` (skeleton; build in Wave 2 of migration) |
| Erasure (right to be forgotten) | `projects/pdpa-erasure/` — service-principal job, ticket-gated, audit-logged |
...
The `projects/pdpa-erasure/` job runs in a single working day; the remaining
