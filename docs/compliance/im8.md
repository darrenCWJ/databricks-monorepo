...
`Restricted` are auto-routed to `@wei_hao_tan @jeffrey_siew` for approval
(CODEOWNERS rule).
...
- `@wei_hao_tan @jeffrey_siew` GitLab group lists individuals cleared to access
...
| Personnel routing | `CODEOWNERS` (`@wei_hao_tan @jeffrey_siew`) |
